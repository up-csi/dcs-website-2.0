...
<Carousel.Root opts={{ align: 'start', dragFree: true }} class="w-screen -ml-[50vw] left-1/2 relative">
    ...
    <Carousel.Previous class="disabled:opacity-0 text-primary-dark shadow-md absolute -left-3 rounded-lg pl-2 h-12 w-12 md:h-16 md:w-20 md:pl-5" />
    <Carousel.Next class="disabled:opacity-0 text-primary-dark shadow-md absolute -right-3 rounded-lg pr-2 h-12 w-12 md:h-16 md:w-20 md:pr-5"/>
</Carousel.Root>