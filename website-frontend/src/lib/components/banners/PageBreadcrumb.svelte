...
<div class="hidden lg:block pb-2 border-b-2">
    <Breadcrumb.Root>
        <Breadcrumb.List class="hover:text-primary">
            ...
            {#if current_path}
                <Breadcrumb.Separator>/</Breadcrumb.Separator>
                <Breadcrumb.Item>
                    <Breadcrumb.Link href={current_path.href}>{current_path.to}</Breadcrumb.Link>
                </Breadcrumb.Item>
            {/if}
        </Breadcrumb.List>
    </Breadcrumb.Root>
...
<div class="lg:hidden pb-2 border-b-2">
    <Breadcrumb.Root>
        <Breadcrumb.List class="hover:text-primary">
            <Breadcrumb.Item class="text-foreground">
                <Breadcrumb.Link href="/">Home</Breadcrumb.Link>
