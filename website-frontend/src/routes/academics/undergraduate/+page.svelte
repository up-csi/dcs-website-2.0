		...
		<div class="px-4 md:px-32">
			<div>
				<div class="flex space-x-2 pb-2 pt-5 text-xs font-medium">
					...
					<p class="opacity-55">/</p>
					<p class="opacity-55">Undergraduate</p>
				</div>
			...
			<div class="space-y-3">
				{#each academics_programs as program}
					{#if typeof program.category !== 'string' && program.category.slug == 'undergraduate'}
			...
			<LinkButton text="Learn More About Academic Processes & Rules Here" link="academics/undergraduate" />
